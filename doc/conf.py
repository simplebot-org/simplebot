...
# built documents.
from deltabot import __version__ as release
...
html_sidebars = {
    ...
    "**": ["sidebarintro.html", "globaltoc.html", "relations.html", "searchbox.html"],
}
...
latex_documents = [
    ("index", "devpi.tex", u"deltabot documentation", u"holger krekel", "manual"),
]
...
man_pages = [("index", "deltabot", u"deltabot documentation", [u"holger krekel"], 1)]
